...
<section class="mt-10 font-ibm">
	...
	<div class="mt-2 hover:underline">
		<a
			...
			rel="noopener noreferrer"
		>
			Enhancing Patient Participation in Emergency Department through Patient-Friendly Clinical
			Notes Generated by Large Language Models
		</a>
	</div>
	<div class="font-light text-sm">
		Sung-In Kim, <u><b>Joonyoung Park</b></u>, Taewan Kim, Woosuk Seo, Taerim Kim, Won Chul Cha,
		Hwajung Hong
		<div class="italic">Scientific Reports 16, 2026</div>
	</div>
	...
	<div class="font-light text-sm">
		...
		<div class="italic">DIS 2025 (*equally contributed)</div>
	</div>
	...
	<div class="font-light text-sm">
		...
		Hajin Lim
		<div class="italic">HCI Korea 2025 (*equally contributed)</div>
	</div>
</section>
